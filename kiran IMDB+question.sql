...
-- Type your code below:
  select min(avg_rating) as min_avg_rating,
		 ...
		 min(median_rating) as min_avg_rating,
...
-- Type your code below:
  ...
  with all_prod_company_rank as
   ...
   select * from all_prod_company_rank
...
-- Type your code below:
select country , count(total_votes) as votes
from movie as m
inner join ratings as r
on m.id=r.movie_id
...
# by observation we can see that german has more votes than italy
...
select name,count(r.movie_id) as movie_count from
names as n
...
-- Type your code below:
   ...
   case 
       ...
       when avg_rating then 'flop movies'
